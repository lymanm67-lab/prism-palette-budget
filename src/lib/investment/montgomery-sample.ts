...
export async function loadMontgomerySample(householdId: string) {
  ...
  const planPayload = {
    ...
    notes: 'Sample plan — employee contributions: Tax-Deferred $35, IU 457(b) $30, Roth TDA $100, Roth 457(b) $175, HSA $366.67. Default planning range 6–10%. First Million target $1M by Jun 2036. $500K life insurance names Montgomery Family Legacy Trust as beneficiary.',
  };
