  ...
  },
  {
    ...
    days: [
      ...
      },
      {
        ...
        drills: [
          'Read the lessons.',
          'Check the Event Risk card on every open trade and note the days until its next report.',
          'List your open trades by sector and mark any group holding three or more names.',
          'Open 1 more qualified paper trade, recording its event risk level in the journal.',
        ],
        practice: { label: 'Open Paper Trading', to: '/swingedge/paper-trading' },
        counter: 'paper_trades_taken',
      },
