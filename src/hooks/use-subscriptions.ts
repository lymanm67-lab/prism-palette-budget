  ...
  return useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await supabase
        ...
        .select('*, categories!subscriptions_category_id_fkey(name, color, group_id, category_groups(budget_type, business_profile_id)), business_category:categories!subscriptions_business_category_id_fkey(name, color)')
