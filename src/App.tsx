...
const WithdrawalSequencerPage = lazy(() => import("@/pages/WithdrawalSequencer"));
...
const SwingEdgeRecommendations = lazy(() => import("./pages/swingedge/Recommendations"));
...
const SwingEdgeRiskLab = lazy(() => import("./pages/swingedge/RiskLab"));
const SwingEdgeRulebook = lazy(() => import("./pages/swingedge/Rulebook"));
        ...
        <AuthProvider>
          ...
          <Routes>
            ...
            <Route element={
              ...
              <Route path="/legacy/sequence-risk" element={<Suspense fallback={<PageLoader />}><SequenceRisk /></Suspense>} />
              ...
              <Route path="/legacy/foundation" element={<Suspense fallback={<PageLoader />}><FamilyFoundation /></Suspense>} />
              ...
              <Route path="/swingedge/recommendations" element={<Suspense fallback={<PageLoader />}><SwingEdgeRecommendations /></Suspense>} />
              ...
              <Route path="/swingedge/risk-lab" element={<Suspense fallback={<PageLoader />}><SwingEdgeRiskLab /></Suspense>} />
              <Route path="/swingedge/rulebook" element={<Suspense fallback={<PageLoader />}><SwingEdgeRulebook /></Suspense>} />
              ...
              <Route path="/swingedge/orders" element={<Suspense fallback={<PageLoader />}><SwingEdgeBrokerOrders /></Suspense>} />
