                    ...
                    {unbudgetedCategories.map(c => {
                      ...
                      return (
                        <div key={c.id} className="flex items-center gap-2 sm:gap-3 py-2 px-3 hover:bg-muted/30 rounded-lg transition-colors group">
                          ...
                          <Button variant="ghost" size="sm" className="h-7 text-xs sm:opacity-0 sm:group-hover:opacity-100" onClick={() => { setForm({ category_id: c.id, planned_amount: '', rollover: false, budgetKind: 'expense', group_id: c.group_id, budgetKind: 'expense', group_id: c.group_id }); setEditingBudget(null); setDialogOpen(true); }}>
