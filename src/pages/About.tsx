        ...
        <div className="lg:col-span-3 space-y-4">
          ...
          <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
            ...
            <p>
              ...
              <em> should</em> go. That's when the idea for PrismMoney™ was born.
            </p>
            <p>
            ...
            <p>
              Today, PrismMoney™ is used by thousands of people to take control of their finances. Some are 
            ...
            <p className="font-medium text-foreground">
              If you're reading this, you're already ahead. You're taking action. And PrismMoney™ is here 
