    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {isLoading
          ...
          : (data?.readings ?? []).map((r) => (
              <Card key={r.symbol} className="overflow-hidden">
        ...
        <CardHeader className="pb-3">
          <div className="flex flex-wrap items-center justify-between gap-2">
            <div>
              ...
              <CardDescription>
                What conditions are right now — never a forecast of what the market will do.
              </CardDescription>
            </div>
            {data ? (
      ...
      <Card>
        <CardHeader className="pb-3">
          ...
          <CardDescription>
            Separate from your retirement, emergency fund, HSA and long-term investments. Trading capital is
            money you have already decided to allocate to trading.
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader className="pb-3">
          ...
          <CardDescription>
            Every setup must answer two questions: why does it qualify, and what would prove it wrong?
          </CardDescription>
        </CardHeader>
        <CardContent>
