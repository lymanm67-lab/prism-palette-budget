...
const PROGRAM = { enrolled: 27578.25, resolved: 23020.99, remaining: 4557.26, pctResolved: 83.48 };
const ACCOUNT_COUNTS = { total: 14, resolved: 10, active: 5 };
...
const ACCOUNTS = [
  ...
  { name: 'Affirm', status: 'Payment Plan In Progress', kind: 'plan', balance: 816.00, payment: '$136.14', remaining: '6', payoff: 'Jan 2027 Final Pmt ~$135.30' },
...
const TOTAL_REMAINING = 4557.26;

const DECLINE = [
  { m: 'AUG 2026', v: 4557 }, { m: 'SEP 2026', v: 4071 }, { m: 'OCT 2026', v: 3113 },
  { m: 'NOV 2026', v: 2147 }, { m: 'DEC 2026', v: 1289 }, { m: 'JAN 2027', v: 452 },
  { m: 'FEB 2027', v: 66 }, { m: 'MAR 2027', v: 0 },
];

const ALLOC = [
  { name: 'Discover', amt: 208.28, pct: 4.6, color: 'hsl(var(--prism-amber))' },
  { name: "Kohl's / Capital One", amt: 479.00, pct: 10.5, color: 'hsl(190 65% 45%)' },
  { name: 'Affirm', amt: 816.00, pct: 17.9, color: 'hsl(var(--prism-orange))' },
  { name: 'Upstart / LVNV', amt: 1487.80, pct: 32.6, color: 'hsl(var(--prism-navy))' },
  { name: 'GLA Collection', amt: 1566.18, pct: 34.4, color: 'hsl(216 90% 45%)' },
];
...
const CAL_ROWS: { name: string; color: string; vals: (string)[] }[] = [
  ...
  { name: 'Affirm', color: 'hsl(280 60% 50%)', vals: ['–', '$136', '$136', '$136', '$136', '$136', '$135', '–', '–', '–'] },
...
const CAL_TOTALS = ['$350', '$486', '$958', '$966', '$858', '$837', '$385', '$66', '–', '–'];
