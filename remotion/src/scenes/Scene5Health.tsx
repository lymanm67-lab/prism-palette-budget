  ...
  return (
    <AbsoluteFill style={{ justifyContent: "flex-start", alignItems: "center", paddingTop: 90 }}>
      <div style={{ opacity: titleIn, transform: `translateY(${interpolate(titleIn, [0, 1], [-30, 0])}px)`, textAlign: "center" }}>
        <p style={{ fontFamily: "sans-serif", fontSize: 48, color: "#EF4444", fontWeight: 700, margin: 0 }}>
          FINANCIAL HEALTH
        </p>
        <p style={{ fontFamily: "sans-serif", fontSize: 30, color: "rgba(180,200,220,0.7)", fontWeight: 400, margin: "8px 0 0" }}>
          Scored. Tracked. Improved.
        </p>
      </div>
      <div style={{
        marginTop: 40,
        ...
        <Img src={staticFile("images/store-ready-5.png")} style={{ width: 700, borderRadius: 24, boxShadow: "0 30px 80px rgba(0,0,0,0.6)" }} />
      </div>
    </AbsoluteFill>
  );
};
